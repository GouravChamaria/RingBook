    ...
    <section id="download" className="py-20 lg:py-28 gradient-saffron relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <AnimatedSection className="text-center">
          ...
          <p className="text-emerald-100/90 font-body text-lg mb-8 max-w-xl mx-auto">
            Download {APP_NAME} free on Android devices.
          </p>
          <a href={PLAY_STORE_URL} target="_blank" rel="noopener noreferrer">
            <Button className="rounded-full bg-white text-emerald-900 hover:bg-emerald-50 hover:scale-[1.04] transition-transform shadow-xl px-10 py-6 text-base font-semibold">
